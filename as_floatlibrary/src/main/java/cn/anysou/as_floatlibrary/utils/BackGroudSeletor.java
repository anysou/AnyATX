...
public class BackGroudSeletor {
    ...
    /**
     * 该方法主要是构建 StateListDrawable 对象，以 StateListDrawable 来设置图片状态，
     * 来表现View的各中状态：未选中，按下 选中效果
     *
    ...
    /**
     * 该方法主要是构建StateListDrawable对象，以StateListDrawable来设置图片状态，
     * 来表现View的各中状态：未选中，按下选中效果
     *
     * @param imagename 选中和未选中使用的两张图片名称
     * @param context   上下文
     */
